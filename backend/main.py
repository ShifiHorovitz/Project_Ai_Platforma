...
# תיקון CORS - הוספנו "*" כדי שזה יעבוד מכל מקום בזמן פיתוח
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"], 
    allow_credentials=True,
...
# הזזנו את יצירת הטבלאות לתוך אירוע startup מסודר עם Try/Except
@app.on_event("startup")
async def startup_event():
    print("Connecting to database...")
    try:
        # יצירת הטבלאות כאן לא תוקעת את טעינת הקובץ
        Base.metadata.create_all(bind=engine)
